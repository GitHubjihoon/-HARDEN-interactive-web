(() => {
	...
	const sceneInfo = [
		...
		},
		{
			...
			values: {
				videoImageCount: 1439,
				imageSequence: [0, 1438],
	...
	js/video/001/section0video000.jpg
	function setCanvasImages() {
		let imgElem;
		for (let i = 0; i < sceneInfo[0].values.videoImageCount; i++) {
			imgElem = new Image();
			imgElem.src = `./video/001/section0video${000 + i}.jpg`;
		...
		for (let i = 0; i < sceneInfo[2].values.videoImageCount; i++) {
			imgElem2 = new Image();
			imgElem2.src = `./video/002/section2video${0000 + i}.jpg`;
